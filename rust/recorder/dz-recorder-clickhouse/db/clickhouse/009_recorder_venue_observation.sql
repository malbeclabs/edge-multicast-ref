...
--
-- Two readers, because the consumers authenticate separately: Grafana's data
-- source as `grafana`, Lake's API as `lake_api`. Granting one leaves the other
-- answering `497`, which reads as that consumer being broken.
--
